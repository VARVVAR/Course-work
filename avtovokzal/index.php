...
function getBusStations() {
    ...
    // Execute the query to retrieve data from the BusStation table
    $query = "SELECT id, name, location FROM BusStation ORDER BY id";
...
$results_bus_stations = getBusStations();
?>
